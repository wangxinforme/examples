...
<body class="fixed-sidebar">
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="ibox" id="ibox">
							<jsp:include page="./master_list_page.jsp" />
						</div>
					</div>
				</div>
			</div>
    ...
    $(document).ready(function() {
      ...
      function list_page() {
        ...
        $("#ibox").load(_ctx + '/news/master/list_page',{"keywords":keywords});
      }

      function editForm(form) {
        $.ajax({
          url: _ctx + "/news/master/edit",
          type: "post",
          data: $(form).serialize(),
      ...
      $("#edit").on('show.bs.modal', function(event) {
        ...
        $("#newsForm").load(_ctx + '/news/master/load/' + id);//加载待编辑数据
      });
      ...
      $('#editable-sample button.delete').on('click', function () {
          ...
          var newsid=$(this).data("id");
              swal({
                  ...
                  $.ajax({
                    url: _ctx + "/news/master/delete/"+newsid,
                    type: "get",
                    success: function(data) {
                      if (data.status == '1') {
