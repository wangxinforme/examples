...
<div class="pages border-top">
	<div class="row">
		<div class="col-md-4">
			<div class="m-t-md">当前显示 ${(page.number-1)*page.size+1 } 到 ${page.number*(page.size) } 条，共 ${page.totalPages } 页 ${page.totalElements } 条</div>
		</div>
		<div class="col-md-8 footable-visible">
			<ul class="pagination pull-right">
				...
				<li class="footable-page-arrow disabled"><a data-page="${(page.number-1)<1?1:(page.number-1) }" href="javascript:void(0);" onclick="goPage(this,'${param.formId }','${param.showPageId }');">‹</a></li>
				...
				<li class="footable-page-arrow"><a data-page="${(page.number+1)>page.totalPages?page.totalPages:(page.number+1) }" href="javascript:void(0);" onclick="goPage(this,'${param.formId }','${param.showPageId }');">›</a></li>
				<li class="footable-page-arrow"><a data-page="${page.totalPages }" href="javascript:void(0);" onclick="goPage(this,'${param.formId }','${param.showPageId }');">»</a></li>
			</ul>
		</div>
